...
var updateListingRoute = exports.updateListingRoute = {
  ...
  handler: function () {
    var _handler = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(request, h) {
      var id, _request$payload, name, description, price, token, user, userId, _yield$db$query, results;
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            id = request.params.id;
            _request$payload = request.payload, name = _request$payload.name, description = _request$payload.description, price = _request$payload.price;
